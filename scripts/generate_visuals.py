"""
Script para generar y exportar gráficos del análisis de clientes.
"""
...
base_path = os.path.dirname(os.path.dirname(__file__))  # sube un nivel desde scripts/
...
plt.savefig(os.path.join(visuals_path, "gender_spend.png"))
plt.close()
...
plt.savefig(os.path.join(visuals_path, "age_gender_spend.png"))
plt.close()
...
plt.savefig(os.path.join(visuals_path, "membership_satisfaction.png"))
plt.close()
...
plt.savefig(os.path.join(visuals_path, "outliers_spend.png"))
plt.close()
...
plt.savefig(os.path.join(visuals_path, "membership_spend.png"))
plt.close()
...
plt.savefig(os.path.join(visuals_path, "city_satisfaction.png"))
plt.close()
...
fig.write_image(os.path.join(visuals_path, "city_sales_plotly.png"))
